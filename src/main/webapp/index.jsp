        ...
        <div class="drop col-3">
          <div class="dropdown">
            ...
            <div class="dropdown__list">
              <a href="#" class="dropdown__item">Hà Nội</a>
              <a href="#" class="dropdown__item">Quảng Ning</a>
              <a href="#" class="dropdown__item">Sài Gòn</a>
              <a href="#" class="dropdown__item">Đà Nẵng></a>
            </div>
    ...
    <div class="myIntro__content container">
      <div class="row">
        ...
        <div class="col-4 myIntro__item d-flex">
          ...
          <div class="Intro__text">
            <h3>Đảm bảo có vé</h3>
            <p>Hoàn ngay 150% nếu không có vé, mang đến hành trình trọn vẹn.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="myStudent owl-carousel owl-theme">
        <div class="item">
          <div class="card" style="width:220px">
            <img class="card-img-top" src="assets/user/images/bx-mien-dong.jpg" alt="Card image" style="width:100%">
        ...
        <div class="item">
          <div class="card" style="width:220px">
            <img class="card-img-top" src="assets/user/images/bx-gia-lam.jpg" alt="Card image" style="width:100%">
            <div iv class="card-body">
        ...
        <div class="item">
          <div class="card" style="width:220px">
            <img class="card-img-top" src="assets/user/images/bx-my-dinh.jpg" alt="Card image" style="width:100%">
            <div iv class="card-body">
        ...
        <div class="item">
          <div class="card" style="width:220px">
            <img class="card-img-top" src="assets/user/images/bx-nuoc-ngam.jpg" alt="Card image" style="width:100%">
            <div iv class="card-body">
        ...
        <div class="item">
          <div class="card" style="width:220px">
            <img class="card-img-top" src="assets/user/images/ben-xe-da-nang-vntrip.jpg" alt="Card image" style="width:100%">
            <div iv class="card-body">
        ...
        <div class="item">
          <div class="card" style="width:220px">
            <img class="card-img-top" src="assets/user/images/ben-xe-dat-lat.jpg" alt="Card image" style="width:100%">
            <div iv class="card-body">
