											...
											<div class="collasp">
												...
												<div class="button">
													<button data-toggle="collapse"
														...
														aria-controls="multiCollapseExample1">chọn chuyến
													</button>
												</div>
											</div>
												...
												<div class="project">
													<ul class="nav nav-pills mb-3" id="pills-tab"
														...
														<li class="nav-item" role="presentation"><a
															...
															aria-selected="false">Tiện ích </a></li>
														<li class="nav-item" role="presentation"><a
															class="nav-link" id="pills-travel-tab" data-toggle="pill"
																...
																<div class="col-12">
																	<div class="card animate__animated animate__zoomIn">
																		<div class="card-body cmt1">
																			...
																			<p>
																				<i class="fa fa-bed">Chăn</i> <span>Nhà xe có
																					trang bị chăn cho hành khách</span>
																			</p>
